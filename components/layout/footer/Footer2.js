                    ...
                    <div className="footer-widget">
                      ...
                      <div className="footer-link-two">
                        <ul className="list-wrap">
                          ...
                          <li>
                            <Link href="/contact">AI Research</Link>
                          </li>
                          <li>
                  ...
                  <div className="col">
                    <div className="footer-widget">
                      ...
                      <div className="footer-link-two">
                        <ul className="list-wrap">
                          <li>
                            <Link href="/faq">85+ Video Avatars</Link>
                          </li>
                          <li>
                            <Link href="/faq">120+ Languages</Link>
                          </li>
                          <li>
                            <Link href="/contact">Custom Avatars</Link>
                          </li>
                          <li>
                            <Link href="/contact">Text to Video</Link>
                          </li>
                          <li>
                            <Link href="/contact">Online Video Maker</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="footer-widget">
                      ...
                      <div className="footer-link-two">
                        <ul className="list-wrap">
                          ...
                          <li>
                            <Link href="/contact">Example videos</Link>
                          </li>
                          <li>
                  ...
                  <div className="col">
                    <div className="footer-widget">
                      ...
                      <div className="footer-link-two">
                        <ul className="list-wrap">
                          <li>
                            <Link href="/contact">Training Videos</Link>
                          </li>
                          <li>
                            <Link href="/contact">How-to Videos</Link>
                          </li>
                          <li>
                            <Link href="/contact">Marketing Videos</Link>
                          </li>
                          <li>
                            <Link href="/contact">Service Providers</Link>
                          </li>
                          <li>
                            <Link href="/contact">Product Updates</Link>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col">
                    <div className="footer-widget">
                      ...
                      <div className="footer-contact-two">
                        <Link href="/tel:0123456789" className="phone">
                          +(1) 123 656 7866
                        </Link>
                        <Link href="/tel:0123456789" className="phone">
                          +(1) 123 656 7866
                        ...
                        <Link
                          href="/mailto:dex.aiinfotive@.com"
                          className="email"
                        >
                          dex.ai infotive@.com
                        </Link>
