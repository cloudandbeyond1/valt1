                  ...
                  <div className="footer-widget">
                    ...
                    <div className="footer-link">
                      <ul className="list-wrap">
                        <li>
                          <Link href="/contact">For teams</Link>
                        </li>
                        <li>
                          <Link href="/contact">For blog writer</Link>
                        </li>
                        <li>
                          <Link href="/contact">For social media</Link>
                        </li>
                        <li>
                          <Link href="/contact">Report Outage</Link>
                        </li>
                        <li>
                          <Link href="/contact">Email Marketing</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="footer-widget">
                    ...
                    <div className="footer-link">
                      <ul className="list-wrap">
                        ...
                        <li>
                          <Link href="/contact">Invite a friend</Link>
                        </li>
                        <li>
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div className="footer-widget">
                    ...
                    <div className="footer-contact">
                      ...
                      <Link href="mailto:dex.aiinfotive@.com" className="email">
                        dex.ai infotive@.com
                      </Link>
                      <Link href="mailto:dex.aiinfotive@.com" className="email">
                        webdexai.com
